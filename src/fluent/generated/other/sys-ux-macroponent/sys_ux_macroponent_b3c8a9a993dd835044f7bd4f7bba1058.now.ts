...
Record({
    $id: Now.ID['b3c8a9a993dd835044f7bd4f7bba1058'],
    ...
    {
        "bundleLink": {
            "bundleInstanceId": "record_list_1",
            "elementType": "member"
        },
        "conditionals": null,
        "definition": {
    ...
    },
    {
        ...
        "overrides": {
            "composition": [
                    ...
                    "overrides": {
                        "composition": [
                            ...
                            },
                            {
                                ...
                                "elementId": "resizable_panes_2",
                                "elementLabel": "Resizable panes 2",
                                "eventMappings": [],
                                "isHidden": {
                                    "type": "JSON_LITERAL",
                                    "value": null
                ...
                {
                    "definition": {
                        "id": "9c14401e25035251d5ea66326d73bdfb",
                        "type": "MACROPONENT"
                    },
                    "elementId": "list_menu_1",
                    "elementLabel": "Menu 1",
                    "eventMappings": [],
                    "isHero": true,
                    "preset": {
                        "controllerElementId": "list_controller",
                        "disabledEventTargetIds": [],
                        "id": "259c0fea9323ce154fa0d7f25995808e"
                    },
                    "propertyValues": {},
                    "slot": "left",
                    "styles": null
        ...
        "preset": {
            "controllerElementId": "list_controller",
            "disabledEventTargetIds": [],
            "id": "37aad4ae880f729c464e9a5a88a409d9"
        },
        "propertyValues": {},
        "slot": null,
        "styles": null
        ...
        data: `[
    {
        ...
        "eventMappings": [
            ...
            {
                "eventMappingId": "clndoggqmqaabbjiiddbhhtrejjhiibtff",
                "isConfiguration": false,
                "offRowStorageId": null,
                "sourceEventApiName": "sn_now_list_common.LIST_CTRL#SELECTED_LIST_UPDATED",
                "sourceEventCorrelationId": null,
                "sourceEventDefinition": {
                    "apiName": "sn_now_list_common.LIST_CTRL#SELECTED_LIST_UPDATED",
                    "id": null,
                    "type": "UXEVENT"
                },
                "sourceEventSysId": null,
                "targets": [
                    {
                        ...
                        "declarativeAction": null,
                        "event": {
                            "apiName": "sn_now_list_common.LIST_TEMPLATE#UPDATE_URL_PARAMS",
                            "payload": {
                                "container": {
                                    "params": {
                                        "container": {
                            ...
                            "sysId": "c83b7669bae290ccf8d719bab49e4c1e"
                        },
                        "operation": null,
                        "targetId": "clndolhhfeeaabbjjddbhhtjiiiclplv",
                        "type": "EVENT"
                    }
                ]
            },
            {
                "eventMappingId": "kKnAiiPlyDkbYjjWUPNuqccbRCS",
                "isConfiguration": false,
                "offRowStorageId": null,
                "sourceEventApiName": "sn_now_list_common.LIST_CTRL#FORM_WRAPPED_ACTION_REQUESTED",
                "sourceEventCorrelationId": null,
                "sourceEventDefinition": {
                    "apiName": "sn_now_list_common.LIST_CTRL#FORM_WRAPPED_ACTION_REQUESTED",
                    "id": null,
                    "type": "UXEVENT"
                },
                "sourceEventSysId": null,
                "targets": [
                    {
                        ...
                        "targetId": "ggTTNfeehhXEAUXljjjgEveejIddypY",
                        "type": "DATABROKER_OP"
                    }
                ]
            },
        ...
        form_factors: '{}',
        handled_events: 'c83b7669bae290ccf8d719bab49e4c1e',
    ...
    "MACROPONENT_PROPERTY_CHANGED": [
        {
            ...
            "clientScript": {
                ...
                "sysId": "70d86da993dd835044f7bd4f7bba104f"
            },
            "conditional": null,
            "declarativeAction": null,
            "event": null,
            "operation": null,
            "targetId": "AtIBRPceehhDaalyeeddIgJmeehxSvBff",
            "type": "CLIENT_SCRIPT"
        }
    ],
    "sn_now_list_common.LIST_TEMPLATE#UPDATE_URL_PARAMS": [
        {
            "broker": null,
            "clientScript": null,
            "conditional": null,
            ...
            "operation": null,
            "targetId": "clnkguheeraaccjbddbhhtffbddyfjjddj",
            "type": "EVENT"
        }
    ]
}`,
