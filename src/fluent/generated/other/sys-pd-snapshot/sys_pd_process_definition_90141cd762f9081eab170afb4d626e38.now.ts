...
Record({
    $id: Now.ID['7278cfaf83e983106a009529feaad3f8'],
    table: 'sys_pd_snapshot',
    data: {
        access: 'public',
        derivatives:
            '{"table":"sys_pd_snapshot","id":"7278cfaf83e983106a009529feaad3f8","name":"derivatives","type":"com.snc.pd.model.serialization.DerivativeFetcher"}',
        name: 'exposure_case',
        process_definition:
            '{"table":"sys_pd_snapshot","id":"7278cfaf83e983106a009529feaad3f8","name":"process_definition","type":"com.snc.pd.model.ProcessDefinition"}',
        process_dependencies:
            '{"table":"sys_pd_snapshot","id":"7278cfaf83e983106a009529feaad3f8","name":"process_dependencies","type":"com.snc.pd.model.dependency.InstructionBasedProcessDependenciesCollection"}',
        process_plan:
            '{"table":"sys_pd_snapshot","id":"7278cfaf83e983106a009529feaad3f8","name":"process_plan","type":"com.snc.process_flow.engine.ProcessPlan"}',
        source: '90141cd762f9081eab170afb4d626e38',
    },
})
